...
<ul class="sidebar-menu" data-widget="tree">
	<li>
		<a href="statistics.php"><i class="fa fa-tachometer"></i>Statistics</a></li>
...
<div class="box-header with-border bg-success">
	<h3 class="box-title">Add new production </h3>
</div>
<!-- /.box-header -->
<div class="box-body">
	<div class="row">
		<div class="col">
			...
			<div class="form-group">
					<h5>No of litre <span class="text-danger">*</span></h5>
					<div class="controls">
						<input type="number" name="s_litre" class="form-control" required data-validation-required-message="Enter your full name"> </div>
					<div class="form-control-feedback"><small>Total no of liter milk prodcution.</small></div>
				</div>
